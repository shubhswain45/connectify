...
>(({ className, ...props }, ref) => {
  const [theme] = useGetCurrentTheme(); // Moved this outside JSX
  ...
  return (
    <SwitchPrimitives.Root
      ...
      // Dynamically changing background based on the switch state
      style={{
        background: props.checked ? theme as string : "#757575", // If checked, set red; otherwise white
      }}
      {...props}
      ref={ref}
    >
      <SwitchPrimitives.Thumb
        ...
        style={{
          backgroundColor: "white", // Keep the thumb color fixed
        }}
      />
    </SwitchPrimitives.Root>
  );
